...
public class TransaksiPiutang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transaksi_piutang);
        ...
        simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String get_update_piutang= piutang.getText().toString().trim();
                update_customer(update_id,get_update_nama, get_update_alamat,get_update_telepon,get_update_piutang);
                Intent i = new Intent(TransaksiPiutang.this, MasterCustomer.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void update_customer(String update_id, String get_update_nama, String get_update_alamat, String get_update_telepon, String get_update_piutang) {
        String URI = "http://192.168.0.101/server-uas-sia/?uas_sia=update";
        RequestQueue queue          = Volley.newRequestQueue(TransaksiPiutang.this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URI, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.toString().equals("data_berhasil_diupdate")){
                    Intent i_main = new Intent(TransaksiPiutang.this, MainActivity.class);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("get_update_piutang", get_update_piutang);
