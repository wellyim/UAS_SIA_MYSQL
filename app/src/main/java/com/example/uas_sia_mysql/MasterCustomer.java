...
public class MasterCustomer extends AppCompatActivity {
    String server_url_select = "http://192.168.0.101/server-uas-sia/?uas_sia=mastercustomer";
    ListView list;
    ListMasterCustomerAdapter ListMasterCustomerAdapter;
    List<ListDataMasterCustomer> itemList = new ArrayList<ListDataMasterCustomer>();
    Button btn_tambah_customer ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_master_customer);
        btn_tambah_customer = findViewById(R.id.btn_tambah_customer);


        list  = (ListView) findViewById(R.id.listCustomer);
        ListMasterCustomerAdapter = new ListMasterCustomerAdapter(MasterCustomer.this, itemList, this);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent i_detail = new Intent( MasterCustomer.this, DetailCustomer.class);
...
//                Toast.makeText(MainActivity.this, get_kodebuku,Toast.LENGTH_LONG).show();
        ...
        btn_tambah_customer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(MasterCustomer.this, InputCustomer.class);
                startActivity(i);
                finish();
            }
        });
...
//                Toast.makeText(MasterCustomer.this,response.toString(),Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MasterCustomer.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        });
